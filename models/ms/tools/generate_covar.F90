...
! model trajectory of Mitchell-Schaeffer. The matrix is decomposed in
...
! *** Determine rank to write ***
  ...
  attstr = 'Mean state, singular vectors and values of decomposed covariance matrix for Mitchell-Schaeffer'
  s = s + 1
